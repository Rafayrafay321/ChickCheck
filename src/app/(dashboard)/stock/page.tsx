  ...
  Live Stock & Inventory</p>
        ...
        <div className="flex items-center gap-3 flex-wrap">
          <button
            ...
            className="inline-flex items-center justify-center gap-1.5 px-4 py-2 bg-blue-600 text-white rounded-lg hover:bg-blue-700 shadow-sm text-sm font-semibold transition-all active:scale-[0.98] cursor-pointer"
          >
            + Chicken Purchase
          </button>
          <button
